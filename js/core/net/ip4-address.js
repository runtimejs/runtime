...
class IP4Address {
  ...
  static parse(str) {
    if (str instanceof IP4Address) return str;
    ...
    for (let i = 0; i < 4; ++i) {
      const v = p[i] | 0;
      if (v !== +p[i] || v < 0 || v > 255) return null;
      a[i] = v;
    }
  ...
  static get ANY() {
    return new IP4Address(0, 0, 0, 0);
  }
  static get BROADCAST() {
    return new IP4Address(255, 255, 255, 255);
  }
  static get LOOPBACK() {
    return new IP4Address(127, 0, 0, 1);
  }
}
